...
import "./sobre.css";
import Eu from "../../assets/nicolas.jpg";
        ...
        <div className="sobre__conteudo">
          <div className="sobre__cards">
            ...
            <article className="sobre_card">
              ...
              <h5>Projetos</h5>
              <small>+20 projetos desenvolvidos</small>
            </article>
          </div>

          <p>
            Trabalho como Desenvolvedor Web na maioria dos projetos e Full Stack em projetos pessoais, utilizando as
